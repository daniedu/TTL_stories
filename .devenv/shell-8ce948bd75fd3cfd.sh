...
DEVENV_PROFILE='/nix/store/4wxb8sfyxagavfykgl9r0xd8626g860c-devenv-profile'
...
prefix='/nix/store/jd9anlb971yx3nl0jdpw18d7zbmnfazk-devenv-shell-env'
DEVENV_DOTFILE='/home/work/Projects/TTL_stories/.devenv'
...
out='/nix/store/jd9anlb971yx3nl0jdpw18d7zbmnfazk-devenv-shell-env'
export out
OSTYPE='linux-gnu'
NIX_STORE='/nix/store'
export NIX_STORE
...
DEVENV_TASK_FILE='/nix/store/kjavl8m0p9n1glq13wks150psq0ffvq7-tasks.json'
...
PKG_CONFIG_PATH='/nix/store/44fi33grmrbkp2h80a31mqj5lqd3qfwp-bash-interactive-5.3p9-dev/lib/pkgconfig'
...
LD='ld'
export LD
NIX_LDFLAGS='-rpath /nix/store/jd9anlb971yx3nl0jdpw18d7zbmnfazk-devenv-shell-env/lib '
export NIX_LDFLAGS
NIX_CC_WRAPPER_TARGET_HOST_x86_64_unknown_linux_gnu='1'
export NIX_CC_WRAPPER_TARGET_HOST_x86_64_unknown_linux_gnu
DEVENV_ROOT='/home/work/Projects/TTL_stories'
export DEVENV_ROOT
NIX_NO_SELF_RPATH='1'
...
NIX_CFLAGS_COMPILE=' -frandom-seed=jd9anlb971 -isystem /nix/store/44fi33grmrbkp2h80a31mqj5lqd3qfwp-bash-interactive-5.3p9-dev/include -isystem /nix/store/znxrv89969njb8fxyyn8rz4ygmmcjpw9-nodejs-22.23.1/include -isystem /nix/store/44fi33grmrbkp2h80a31mqj5lqd3qfwp-bash-interactive-5.3p9-dev/include -isystem /nix/store/znxrv89969njb8fxyyn8rz4ygmmcjpw9-nodejs-22.23.1/include'
...
nativeBuildInputs='/nix/store/44fi33grmrbkp2h80a31mqj5lqd3qfwp-bash-interactive-5.3p9-dev /nix/store/znxrv89969njb8fxyyn8rz4ygmmcjpw9-nodejs-22.23.1 /nix/store/gfrj5gwr59daw5qi72phra770mi0xvh1-pnpm-11.9.0 /nix/store/kx8jj7rp0ix22782ln81y9m6ix92i48c-typescript-language-server-5.3.0 /nix/store/znxrv89969njb8fxyyn8rz4ygmmcjpw9-nodejs-22.23.1 /nix/store/gfrj5gwr59daw5qi72phra770mi0xvh1-pnpm-11.9.0 /nix/store/sq5p43ziv78vxp51rpaajhvz0584lgqw-pkg-config-wrapper-0.29.2'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/sr26flm2nkfa12dkrwj2630kqsfakky4-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/4wxb8sfyxagavfykgl9r0xd8626g860c-devenv-profile" ]
then
  ln -snf /nix/store/4wxb8sfyxagavfykgl9r0xd8626g860c-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-2adc6b8
ln -snf /run/user/1000/devenv-2adc6b8 /home/work/Projects/TTL_stories/.devenv/run
...
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/work/Projects/TTL_stories:"* ]]; then
...
'
export shellHook
DEVENV_STATE='/home/work/Projects/TTL_stories/.devenv/state'
export DEVENV_STATE
...
shell='/nix/store/zh1ijdhb6gng1509b1zrilb6xlzx60j6-bash-5.3p9/bin/bash'
export shell
XDG_DATA_DIRS='/nix/store/0641h8qfqaxnwrsw2nzrz6i1wbzyx92l-bash-interactive-5.3p9/share:/nix/store/znxrv89969njb8fxyyn8rz4ygmmcjpw9-nodejs-22.23.1/share:/nix/store/gfrj5gwr59daw5qi72phra770mi0xvh1-pnpm-11.9.0/share:/nix/store/sq5p43ziv78vxp51rpaajhvz0584lgqw-pkg-config-wrapper-0.29.2/share:/nix/store/jbav217344pndjbghzyjmh0mkzy1973i-patchelf-0.15.2/share'
...
exec bash -c 'echo "{\"onlyBuiltDependencies\":[\"protobufjs\",\"unrs-resolver\"]}" > .pnpmrc.json && pnpm install && pnpm run build'